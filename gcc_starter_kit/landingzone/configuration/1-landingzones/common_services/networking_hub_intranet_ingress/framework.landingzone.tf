...
# example usage
# local.remote.networking.virtual_networks.hub_intranet_ingress.id 
# local.remote.networking.virtual_networks.hub_intranet_ingress.name 
# local.remote.networking.virtual_networks.hub_intranet_egress.id 
# local.remote.networking.virtual_networks.hub_intranet_egress.name 
