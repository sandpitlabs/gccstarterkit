module "container_group1" {
  source  = "./../../../../../../modules/compute/terraform-azurerm-avm-res-compute-containergroup"
  ...
  subnet_ids          = [local.remote.networking.virtual_networks.spoke_devops.virtual_subnets.subnets["RunnerSubnet"].id]
