...
module "virtualnetwork_hub_internet_ingress" {
  ...
  vnet_name                     = local.ingress_egress_vnet_name_ingress_internet # "vnet-hub-internet"
...
module "virtualnetwork_hub_intranet_egress" {
  ...
  vnet_name                     = local.ingress_egress_vnet_name_egress_intranet # "vnet-hub-internet"
  enable_telemetry              = true
  resource_group_name           = azurerm_resource_group.this.name
  vnet_location                 = var.location # "southeastasia"
...
module "virtualnetwork_project" {
  ...
  vnet_name                     = local.internet_vnet_name # "vnet-hub-internet"
  enable_telemetry              = true
  resource_group_name           = azurerm_resource_group.this.name
  vnet_location                 = var.location # "southeastasia"
  virtual_network_address_space = ["${local.internet_vnet_name_cidr}"]
  subnets = {}   
}
...
module "virtualnetwork_management" {
  ...
  vnet_name                     = local.management_vnet_name # "vnet-hub-internet"
  enable_telemetry              = true
  resource_group_name           = azurerm_resource_group.this.name
  vnet_location                 = var.location # "southeastasia"
...
module "virtualnetwork_devops" {
  ...
  vnet_name                     = local.devops_vnet_name # "vnet-hub-internet"
  enable_telemetry              = true
  resource_group_name           = azurerm_resource_group.this.name
  vnet_location                 = var.location # "southeastasia"
